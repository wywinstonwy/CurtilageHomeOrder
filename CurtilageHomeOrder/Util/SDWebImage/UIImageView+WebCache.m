...
{
    [self sd_setImageWithURL:[NSURL URLWithString:[urlStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:placeholder options:0 progress:nil completed:nil];
}
